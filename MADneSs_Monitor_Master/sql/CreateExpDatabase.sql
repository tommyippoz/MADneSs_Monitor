...
create table failure (failure_id int primary key auto_increment, failure_type_id int, run_id int, fa_description varchar(100), fa_time datetime, fa_duration int default 2, 
